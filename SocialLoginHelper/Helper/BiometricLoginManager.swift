...
class BiometricLoginManager: NSObject {
    ...
    enum BiometricError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .biometryNotEnrolled: return "Face ID/Touch ID is not set up. Please setup it from Setting screen."
